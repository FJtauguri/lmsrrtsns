                                        ...
                                        <div class="x_title">
                                            <div class="container d-flex pb-3"
                                                ...
                                                <li>
                                                    ...
                                                    <a href="book_print.php" style="background:none;"
                                                        id="buttons_print">
                                            ...
                                            <ul class="nav nav-pills mb-3 pt-3 pb-3" id="navpillsZ" style="border: 1px solid #000; align-items: center;">
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'book_lists.php') ? 'active show' : ''; ?>"><a
                                                        href="book_lists.php">All</a></li>
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'new_books.php') ? 'active show' : ''; ?>"><a href="new_books.php">New
                                                        Books</a></li>
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'old_books.php') ? 'active show' : ''; ?>"><a href="old_books.php">Old
                                                        Books</a></li>
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'lost_books.php') ? 'active show' : ''; ?>"><a href="lost_books.php">Lost
                                                        Books</a></li>
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'damage_books.php') ? 'active show' : ''; ?>"><a href="damage_books.php">Damaged
                                                        Books</a>
                                                </li>
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'sub_rep.php') ? 'active show' : ''; ?>"><a href="sub_rep.php">Subject for Replacement
                                                        Books</a></li>
                                                <li id="navpills" role="presentation" class="<?php echo ($current_page == 'hard_bound.php') ? 'active show' : ''; ?>"><a href="hard_bound.php">Hardbound Books</a>
                                                </li>
                                            </ul>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="x_content">
                                            ...
                                            <div class="table-responsive">
                                                <table cellpadding="0" cellspacing="0" border="0"
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $result = mysqli_query($con, "select * from book where status = 'Damage' ") or die(mysqli_error());
